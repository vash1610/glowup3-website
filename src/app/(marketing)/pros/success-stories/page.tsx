...
const stories = [
  { name: 'Anna Novak', role: 'Hair Stylist', location: 'Prague', growth: '3x revenue', icon: 'hair', quote: 'Todayly completely changed my business. The Available Now feature fills my slow hours with last-minute bookings I would never have gotten otherwise.', before: '€1,500/mo', after: '€4,500/mo', clients: '+200%' },
  { name: 'David M.', role: 'Massage Therapist', location: 'Brno', growth: '250 clients', icon: 'massage', quote: 'I was struggling to find clients after moving to a new city. Within 3 months on Todayly, I had a full schedule and steady income.', before: '€800/mo', after: '€3,200/mo', clients: '+150%' },
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          <p className={styles.subtitle}>Hear from professionals who transformed their business with Todayly</p>
        </div>
      </section>
      ...
      <section className={styles.cta}>
        <div className={styles.container}>
          <div className={styles.ctaCard}>
            ...
            <p>Join 1,200+ professionals already growing their business with Todayly.</p>
