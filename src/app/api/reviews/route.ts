...
const reviews = [
  { id: 1, author: 'Martina K.', rating: 5, text: 'GlowUp3 transformed my business. The Available Now feature brings me customers even during slow days.', service: 'Hair Styling', date: '2026-04-28' },
  ...
  { id: 5, author: 'Eva H.', rating: 5, text: 'Found my favorite hair stylist on GlowUp3. Never going anywhere else!', service: 'Hair Styling', date: '2026-04-15' },
];
